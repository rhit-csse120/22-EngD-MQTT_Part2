...
and a Pico (running  code.py  from example_src_on_pico).
...
def main():
    ...
    # Connect to the broker, start the event loop for the MqttClient,
    # in its own thread, and subscribe to the relevant topic.
    mqtt_client.start()
